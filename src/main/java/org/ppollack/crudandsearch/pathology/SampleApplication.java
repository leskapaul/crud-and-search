...
/**
 * This sample application depends on mySQL, MongoDB, and Elasticsearch running on localhost.
 * Use Docker Compose file compose-es-mysql-mongo.yml, in this project, to run them all locally.
